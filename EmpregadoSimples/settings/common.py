...
ADMINS = (
     ('Thiago Paiva', 'tpborion@gmail.com'),
     ('Ionay Silva', 'ionaysilva@gmail.com'),
)
...
STATICFILES_DIRS = (
    ...
    os.path.abspath(os.path.join(os.path.dirname( __file__ ), os.path.pardir, os.path.pardir , 'static')),
)
...
SECRET_KEY = '6&u4c@_c)9fw21c-!#=x_ypa0y)gq#!wc_0h1@na%**=pigs$k'
