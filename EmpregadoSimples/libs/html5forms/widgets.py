...
class Html5TextInput(forms.widgets.TextInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        if hasattr(self,'datalist') and self.datalist and isinstance(self.datalist, (tuple, list)):
...
class Html5DateInput(Html5TextInput):
    input_type = 'date'
...
class Html5DateTimeInput(Html5TextInput):
    input_type = 'datetime'

    def __init__(self, *args, **kwargs):
        super(Html5DateTimeInput, self).__init__(*args, **kwargs)
        self.datalist = None
