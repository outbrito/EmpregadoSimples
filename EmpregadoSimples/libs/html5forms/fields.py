...
from widgets import Html5SearchInput, Html5EmailInput, Html5DateInput, Html5DateTimeInput
...
class Html5BaseTemporalField(Html5Field):
    def __init__(self, input_formats=None, *args, **kwargs):
        super(Html5BaseTemporalField, self).__init__(*args, **kwargs)
...
class Html5DateField(Html5BaseTemporalField):
    """ Date Field
    ...
    def to_python(self, value):
        ...
        if isinstance(value, datetime.date):
            return value
        return super(Html5DateField, self).to_python(value)

    def strptime(self, value, format):
        return datetime.datetime.strptime(value, format).date()


class Html5DateTimeField(Html5BaseTemporalField):
    """ DateTime Field
    ...
    def to_python(self, value):
        ...
        result = super(Html5DateTimeField, self).to_python(value)
        return from_current_timezone(result)
